...
const spotifyApi = new SpotifyWebApi({
  ...
  redirectUri: process.env.SPOTIFY_REDIRECT_URI || 'http://localhost:3000/api/callback' // Fallback for worker context
});
...
const profileWorker = new Worker('profile-generation', async (job) => {
